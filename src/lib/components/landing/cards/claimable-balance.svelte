...
<Card>
  <CardHeader>
    ...
    <CardTitle class="text-4xl tabular-nums">{formatCurrency(totalClaimable)}</CardTitle>
    ...
    <Item variant="muted" class="flex-col items-stretch">
      <ItemContent class="gap-3">
        <div class="flex items-center justify-between">
          ...
          <span class="text-sm font-medium tabular-nums">{formatCurrency(netRoyalties)}</span>
        </div>
        <div class="flex items-center justify-between">
          <span class="text-sm text-muted-foreground">Processing Fee</span>
          <span class="text-sm font-medium tabular-nums">-{formatCurrency(processingFee)}</span>
        </div>
        <Separator />
        <div class="flex items-center justify-between">
